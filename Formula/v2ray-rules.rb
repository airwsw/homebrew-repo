class V2rayRules < Formula
  ...
  resource "apple-cn" do
    ...
    sha256 "0ad226f1a486f2ffc367ea02816a757c8a3857e76f38bafbc667558a4fa1468f" # apple-cn.txt
  end
  resource "direct-list" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/direct-list.txt"
    sha256 "e65e6310efd20f520be9d335fce56cbe50da719d9ef428ff06716daa345625f8" # direct-list.txt
  end
  ...
  resource "geoip" do
    ...
    sha256 "b43c9e502e91f64a2726ab8a2a8f1a20a6e78fb4cc1da1bab6c211d58793c276" # geoip.dat
  end
  resource "geosite" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geosite.dat"
    sha256 "232b4adbfa696117698391aad707da93e5155fec87abfa48f08632bdabd41e51" # geosite.dat
  end
  resource "gfw" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/gfw.txt"
    sha256 "ff2b219eb1f509dc8a442790348212499a0b1b827a007dac6bad281d1e35306b" # gfw.txt
  end
  resource "google-cn" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/google-cn.txt"
    sha256 "37c4acbe307435f46738539a29c94acb400d1110c02249adb1b3d9a80a540857" # google-cn.txt
  end
  ...
  resource "proxy-list" do
    ...
    sha256 "43210e9a6688e003982a1c9b5e37d1b825d666fc96bd2504f4d331b2bd3d99c6" # proxy-list.txt
  end
  ...
  resource "reject-list" do
    ...
    sha256 "f40c5c18d393c08021c207f2372cc166338d483e1cbf914e0060eb4cfd707a0e" # reject-list.txt
  end
