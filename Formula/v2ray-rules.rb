class V2rayRules < Formula
  ...
  resource "apple-cn" do
    ...
    sha256 "783edfc3792000b277b992119c797ed6b41d7dacaab5faa2bbeed7ad28829036" # apple-cn.txt
  end
  resource "direct-list" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/direct-list.txt"
    sha256 "ec77e655167acce0bc7688d2c580bea951f961badfcce957ddd7de24511d4cd2" # direct-list.txt
  end
  ...
  resource "geoip" do
    ...
    sha256 "f3939782fa426bba8bcd819a5fe60b3034cf046bd968ca5bd4834e16718cd53c" # geoip.dat
  end
  resource "geosite" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geosite.dat"
    sha256 "24b9872d94a7cb87dcfcf65f414c010aae672eac905305a35de0086412736088" # geosite.dat
  end
  resource "gfw" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/gfw.txt"
    sha256 "1582337b382c8976f6d44cc90016b239048d19fcb42877f805ec50e07625e71b" # gfw.txt
  end
  ...
  resource "proxy-list" do
    ...
    sha256 "959d2d5d8a31b93e85f5d2ef0505cb7f407385f516f64c7c91a68ab5018ea104" # proxy-list.txt
  end
  resource "proxy-tld-list" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/proxy-tld-list.txt"
    sha256 "a2a5d9b6a76edf8ca984472b272f84c15ff8ae8cb33a81df731d391b9d49c7c7" # proxy-tld-list.txt
  end
  resource "reject-list" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/reject-list.txt"
    sha256 "828d4c54e10831b8a942308c3fb9c0f752d31786fc682991568c7172cf584830" # reject-list.txt
  end
