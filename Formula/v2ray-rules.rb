class V2rayRules < Formula
  ...
  resource "apple-cn" do
    ...
    sha256 "0fc4047a4d7431d539d86fe1698c34eda8980ac55ec217166cabe9ccdd521e9a" # apple-cn.txt
  end
  resource "direct-list" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/direct-list.txt"
    sha256 "704f3724d98cca6a852db5d1a63442f257a64b73b4456a301b89f62fc47b5bdb" # direct-list.txt
  end
  ...
  resource "geoip" do
    ...
    sha256 "0d8fb29e4352486205d8dae60ab455b3e69d50911df2e94a854cbf1d70921813" # geoip.dat
  end
  resource "geosite" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geosite.dat"
    sha256 "286c0eb011ee8e0f86851f640ed0546e5f9b4492b88d817886c8813a46714247" # geosite.dat
  end
  resource "gfw" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/gfw.txt"
    sha256 "d880670df9ceb68667ade6aa14731ed9a1370c65ace575b402a7efe22788f41f" # gfw.txt
  end
  ...
  resource "proxy-list" do
    ...
    sha256 "b64f69dd72dcce77f83f4f5c7f4f8cdd53a449327793c4f2336ca32f374c5f1a" # proxy-list.txt
  end
  resource "proxy-tld-list" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/proxy-tld-list.txt"
    sha256 "97e00293075077aea3b5e452ad9ddeaff7fa1f07d7a559544cd1d8f85b8a360d" # proxy-tld-list.txt
  end
  resource "reject-list" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/reject-list.txt"
    sha256 "2466aab6a7c94ae26c5d0b0c676b6ca128aa5165ff02f6c2a924d199dfaf543e" # reject-list.txt
  end
