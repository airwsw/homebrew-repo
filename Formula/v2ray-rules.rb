class V2rayRules < Formula
  ...
  resource "direct-list" do
    ...
    sha256 "7a0d35757110df04ae552cb77cec0670a611a7b1afe02a255d316c0df7019aca" # direct-list.txt
  end
  ...
  resource "geoip" do
    ...
    sha256 "da75fca4ad983be5bafb2fd14c24e093a7edcc49731a6e0340233d1318166a6f" # geoip.dat
  end
  resource "geosite" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geosite.dat"
    sha256 "e88084108e452edb35ec47ace8773afb3e084660abe87d89f2bcadfb458d7c7c" # geosite.dat
  end
  resource "gfw" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/gfw.txt"
    sha256 "1baabec9d8200323888fe2c6fcb8b1bd8ac3210aa60040bd90d2b07c0554613d" # gfw.txt
  end
  ...
  resource "proxy-list" do
    ...
    sha256 "7491d630dcbd5b1ab6c3b10c45bc747a55d8a9d6a932fa069e731a909db24555" # proxy-list.txt
  end
  resource "proxy-tld-list" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/proxy-tld-list.txt"
    sha256 "bfe8e38de863514c00bd474cc8d98c1bc4411a4eefca885bd2d73098371238c1" # proxy-tld-list.txt
  end
  resource "reject-list" do
    url "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/reject-list.txt"
    sha256 "16e934dba5bc29dd88d4518c9a3384b6594474f4a172a2ff6ff4f8cb3dbd4022" # reject-list.txt
  end
